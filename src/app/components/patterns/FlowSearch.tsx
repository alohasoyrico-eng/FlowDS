...
import { GrowthObserver, stateAttrs } from "../../primitives";
...
export const FlowSearch = forwardRef<HTMLInputElement, SearchProps>(
  (
    ...
    // FlowTextInput doesn't expose aria-label or aria-invalid on the inner <input>,
    // so we set them imperatively via the shared ref (justified thin wrapper).
    useEffect(() => {
