...
export const FlowToolbar = forwardRef<HTMLDivElement, ToolbarProps>(
...
export const FlowToolbarDivider = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ...
  return <div ref={ref} className="flow-toolbar-divider" role="separator" aria-orientation="vertical" {...rest} />;
}
);
FlowToolbarDivider.displayName = "FlowToolbarDivider";

/** Group of items within a toolbar */
export const FlowToolbarGroup = forwardRef<HTMLDivElement, {
  children: ReactNode;
  className?: string;
} & React.HTMLAttributes<HTMLDivElement>>(
  function FlowToolbarGroup({
  children,
  className = "",
  ...rest
}, ref) {
