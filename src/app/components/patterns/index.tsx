...
/** @deprecated Moved to inputs/ — re-exported for backward compatibility */
export { FlowPhoneInput } from "../inputs/FlowPhoneInput";
export type { PhoneInputProps } from "../inputs/FlowPhoneInput";
/** @deprecated Moved to selection/ — re-exported for backward compatibility */
export { FlowCountrySelect } from "../selection/FlowCountrySelect";
export type { CountrySelectProps } from "../selection/FlowCountrySelect";
...
/** @deprecated Moved to inputs/ — re-exported for backward compatibility */
export { FlowOTPInput } from "../inputs/FlowOTPInput";
export type { OTPInputProps } from "../inputs/FlowOTPInput";
...
/** @platform shared — composes N Avatar + overflow indicator */
export { FlowAvatarGroup } from "../display/FlowAvatarGroup";
...
export type { AdvancedFiltersProps } from "./FlowAdvancedFilters";
/** @platform desktop */
