...
import { FlowIcon, GrowthObserver, Inline, Stack, Surface, Text, type Tone } from "../../primitives";
...
export const FlowKPICard = forwardRef<HTMLDivElement, KPICardProps>(
    ...
    >
      <Stack gap={2}>
        ...
        <Inline gap={2} style={{ alignItems: "center" }}>
          ...
          <Text role="overline" color="secondary" tone={tone}>
            {label}
          </Text>
        </Inline>
        ...
        <Inline gap={2} style={{ alignItems: "center" }}>
          ...
          {description && (
            <Text role="paragraph-s" color="secondary" tone={tone}>
              {description}
            </Text>
          )}
        </Inline>
