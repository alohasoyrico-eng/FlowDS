...
import { FlowIcon, GrowthObserver, Inline, Stack, Text, type Tone } from "../../primitives";
...
export const FlowEmptyState = forwardRef<HTMLDivElement, EmptyStateProps>(
  ...
  return (
    ...
    >
      ...
      <Stack gap={resolvedSize === "sm" ? 1 : 2} align="center" style={{ textAlign: "center" }}>
        <Text role="heading-m" color="primary" tone={tone}>
          {title}
        </Text>
        {description && (
          <Text
