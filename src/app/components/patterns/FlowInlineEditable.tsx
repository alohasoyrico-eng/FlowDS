...
import { stateAttrs } from "../../primitives";
  ...
  if (editing) {
    return (
      <span
        ...
        style={{ display: "inline-flex", alignItems: "center", gap: "var(--ref-frame-space-1)", ...style }}
        onBlur={(e) => {
      ...
      >
        ...
        />
        <FlowIconButton icon="check" aria-label="Save" onClick={commit} size="sm" variant="ghost" />
        <FlowIconButton icon="x" aria-label="Cancel" onClick={cancel} size="sm" variant="ghost" />
      </span>
    );
  }
