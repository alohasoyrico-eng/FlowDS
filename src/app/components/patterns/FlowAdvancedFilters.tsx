...
import { FlowIcon, Inline, Stack, Surface, Text } from "../../primitives";
      ...
      <Stack gap="component">
        <Inline gap={2} justify="between">
          <Inline gap={2}>
            ...
            <Text role="label-m">Filters {filters.length > 0 && `(${filters.length})`}</Text>
          </Inline>
          <Inline gap={2}>
            {filters.length > 0 && (
          ...
          return (
            ...
            >
              ...
              <FlowSelect
                ...
                size="sm"
                style={{ flex: "0 0 auto", minWidth: "var(--comp-advanced-filters-field-min-width)" }}
              />
              ...
              <FlowSelect
                ...
                size="sm"
                style={{ flex: "0 0 auto", minWidth: "var(--comp-advanced-filters-operator-min-width)" }}
              />
        ...
        {filters.length > 0 && onApply && (
          <Inline justify="end">
            <FlowButton variant="high" onClick={onApply}>
              Apply Filters
            </FlowButton>
          </Inline>
        )}
