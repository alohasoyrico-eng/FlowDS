...
import { forwardRef, type ReactNode, type Ref, useCallback, useEffect, useId, useRef, useState } from "react";

import { useFlowAnnounce } from "../../hooks/use-flow-announce";
import { useFlowDefaultSize } from "../../hooks/use-flow-default-size";
import { GrowthObserver, Surface, Text, type Tone } from "../../primitives";
...
export const FlowTooltip = forwardRef<HTMLSpanElement, TooltipProps>(
      ...
      >
        ...
        {visible && (
          <Surface
            ...
            data-tone={tone}
          >
            <Text as="span" role="caption" color="inherit">{content}</Text>
