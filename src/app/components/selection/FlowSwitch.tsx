...
export const FlowSwitch = forwardRef<HTMLButtonElement, SwitchProps>(
  function FlowSwitch({
  ...
  if (label) {
    return (
      ...
      >
        {switchButton}
        <Text as="span" role="label-m" className="flow-switch-label-text" onClick={disabled ? undefined : handleToggle}>
          {label}
        </Text>
      </div>
    );
