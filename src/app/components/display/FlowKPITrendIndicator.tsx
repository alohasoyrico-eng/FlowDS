...
export const FlowKPITrendIndicator = memo(forwardRef<HTMLSpanElement, KPITrendIndicatorProps>(
  function FlowKPITrendIndicator({
    value,
    direction = "neutral",
    upIsGood = true,
    label,
  ...
  return (
    ...
    >
      <FlowIcon
        ...
        size="sm"
      />
      <Text role="caption" color="inherit">
        {value}
      </Text>
      {label && (
