...
export const FlowTreeView = forwardRef<HTMLUListElement, TreeViewProps>(
  ...
  if (loading) {
    return (
      ...
      >
        {[1, 2, 3].map((i) => (
          <li key={i} role="treeitem" className="flow-tree-skeleton" aria-selected={false} aria-disabled="true">
