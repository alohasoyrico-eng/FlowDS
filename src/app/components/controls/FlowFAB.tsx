...
type FABVariant = "primary" | "secondary" | "tertiary" | "standard" | "extended";
...
export const FlowFAB = memo(forwardRef<HTMLButtonElement, FABProps>(
  (
    {
      icon,
      label,
    ...
    return (
      <GrowthObserver event="flow.fab.impression" properties={{ size: resolvedSize, variant }} inline>
      <ActionSurface
        ref={ref}
        type={type}
        disabled={disabled}
