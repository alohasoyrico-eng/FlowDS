...
export const FlowSplitPane = forwardRef<HTMLDivElement, SplitPaneProps>(
  function FlowSplitPane(
    {
    ...
    return (
      ...
      >
        ...
        <Surface padding="none" border={false} elevation={0} radius="none" style={{ flex: 1, overflow: "auto", minWidth: 0, minHeight: 0 }}>{second}</Surface>
      </div>
    );
  },
);
