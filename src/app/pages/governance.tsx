import { CodeBlock, FlowChip, Inline, Stack, Surface, Text } from "../../lib";
  ...
  return (
    <Stack gap={PAGE_GAP}>
      <PageHeader chapter="Chapter 09" title="Governance & Contribution">
        A design system without governance degrades to a component library — a collection of parts
        without the constraints that make them a system. Flow&apos;s governance model ensures
        consistency, quality, and evolution at organizational scale.
      </PageHeader>
        ...
        <Stack gap={2}>
          {[
            ...
            <Surface key={r.role} padding="control">
              <Stack gap={2}>
                <Text role="label-l">{r.role}</Text>
                <Text role="paragraph-s">{r.desc}</Text>
              </Stack>
            </Surface>
          ))}
        </Stack>
        ...
        <Stack gap={2}>
          {[
            ...
            <Surface key={c.check} padding="control">
              <Stack gap={2}>
                <Inline gap={3}>
                  <Text role="label-l">{c.check}</Text>
                  <FlowChip
                    size="sm"
                    variant={
        ...
        <Stack gap={2}>
          {[
            ...
            <Surface key={d.view} padding="control">
              <Stack gap={2}>
                <Text role="label-l">{d.view}</Text>
                <Text role="paragraph-s">{d.content}</Text>
              </Stack>
            </Surface>
          ))}
        </Stack>
          ...
          {[
            ...
            <Surface key={p.phase} padding="control">
              <Inline gap={4}>
                ...
                <Stack gap={1}>
                  <Text role="label-l">{p.phase.split(". ")[1]}</Text>
                  <Text role="paragraph-s">{p.desc}</Text>
                </Stack>
              </Inline>
            </Surface>
          ))}
