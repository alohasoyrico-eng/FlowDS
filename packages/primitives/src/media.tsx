...
import { type FlowIcon as FlowIconDef, flowIcons } from "@flow/icons";
import { FLAG_CELL_SIZE, flagByCode, type FlagSize, flagSizeMap } from "@flow/flags";
...
function useFrame8() {
  ...
  useEffect(() => {
    ...
    if (!frame8Promise) {
      frame8Promise = import("./Frame8").then((mod) => {
