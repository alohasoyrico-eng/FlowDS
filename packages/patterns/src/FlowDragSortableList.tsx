...
export const FlowDragSortableList = forwardRef<HTMLDivElement, DragSortableListProps>(
  function FlowDragSortableList(
    { items, onReorder, handle = true, size = "md", className = "", style, ...rest },
    ref,
  ) {
    ...
    return (
      <GrowthObserver event="flow.drag-sortable-list.impression">
        <div
          ref={ref}
          role="listbox"
          ...
          {items.map((item, idx) => {
            ...
            return (
              ...
              >
                {handle && (
                  ...
                  >
                    <Inline gap={0} style={{ gap: "var(--comp-drag-handle-dot-gap)" }}>
                      <div
                        style={{
                          width: "var(--comp-drag-handle-dot-size)",
                          height: "var(--comp-drag-handle-dot-size)",
                          borderRadius: "50%",
                ...
                <Text variant="paragraph-s" style={{ flex: 1, minWidth: 0 }}>
                  {item.content}
                </Text>
              </div>
            );
