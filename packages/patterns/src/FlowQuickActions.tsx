...
import { Divider, GrowthObserver, Surface, Text } from "@flow/primitives";
...
export interface QuickAction {
  ...
  /** Icon name */
  icon?: string;
  /** Action intent (danger shows a destructive-styled action) */
  ...
  function FlowQuickActions(
    ...
    useEffect(() => {
      ...
      requestAnimationFrame(() => {
        const firstBtn =
          sheetRef.current?.querySelector<HTMLButtonElement>("button:not(:disabled)");
        firstBtn?.focus();
      });
    }, [open]);
    ...
    return (
      <GrowthObserver event="flow.quick-actions.impression">
        <div
          ref={ref}
          {...rest}
        ...
        >
          <div
            ...
            style={{
              ...
              animation:
                "flow-slide-up var(--ref-momentum-duration-slide) var(--sys-momentum-easing-enter)",
            }}
          >
            {/* Actions group */}
