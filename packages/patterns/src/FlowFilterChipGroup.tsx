...
export const FlowFilterChipGroup = forwardRef<HTMLDivElement, FilterChipGroupProps>(
  function FlowFilterChipGroup(
    { chips, selected, onSelectionChange, exclusive = false, className = "", style, ...rest },
    ref,
  ) {
    ...
    return (
      <GrowthObserver event="flow.filter-chip-group.impression">
        <div
          ref={ref}
          {...rest}
              ...
              >
                ...
                {chip.count !== undefined && (
                  <Text
                    variant="caption"
                    color="inherit"
                    style={{ opacity: "var(--ref-state-opacity-muted)" }}
                  >
                    {chip.count}
                  </Text>
                )}
