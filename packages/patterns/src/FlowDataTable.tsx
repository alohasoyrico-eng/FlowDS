...
import type { FlowTableColumn } from "@flow/components";
import {
  FlowIcon,
  GrowthObserver,
  Inline,
...
export function FlowDataTable<T extends Record<string, unknown>>({
  ...
  return (
    <GrowthObserver event="flow.data-table.impression">
      <Surface
        radius="container"
        border
        padding={0}
          ...
          {error && !loading && (
            ...
            >
              <Inline gap={2}>
                ...
                <Text variant="paragraph-s" color="danger">
                  {errorMsg}
                </Text>
              </Inline>
            </div>
          ...
          >
            {caption && (
              <caption className="flow-table-caption">
                <Text variant="paragraph-s">{caption}</Text>
              </caption>
            )}
              ...
              <tr className="flow-table-head-row">
                ...
                {selectable && (
                  <th
                    ...
                    style={{ width: "var(--ref-frame-space-12)", textAlign: "center" }}
                  >
                    <input
                      type="checkbox"
                      checked={allSelected}
