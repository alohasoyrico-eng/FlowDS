...
import { FlowIcon, GrowthObserver } from "@flow/primitives";
...
type SwipeActionIntent = "danger" | "success" | "warning" | "default";
...
export const FlowSwipeActions = forwardRef<HTMLDivElement, SwipeActionsProps>(
  function FlowSwipeActions(
      ...
      <div className="flow-swipe-actions-panel" data-side={side}>
        {actions.map((action) => (
          <button
            ...
            data-intent={action.intent || "default"}
    ...
    return (
      <GrowthObserver event="flow.swipe-actions.impression">
