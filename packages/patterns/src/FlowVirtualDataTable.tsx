...
import { FlowCheckbox, FlowIconButton, FlowTextInput } from "@flow/components";
...
function FlowVirtualDataTableInner<T extends object>(
  ...
  return (
    <GrowthObserver event="flow.virtual-data-table.impression">
      <div ref={ref} {...rest} data-size={resolvedSize} {...stateProps}>
        <Surface
          radius="container"
          border
          padding={0}
        ...
        >
          ...
          {showToolbar && (
            ...
            >
              {selectable && selected.size > 0 && (
                <Text variant="paragraph-s" color="accent" style={{ whiteSpace: "nowrap" }}>
          ...
          >
            ...
            <div role="rowgroup">
              <div
                style={{
                  display: "flex",
                  borderBottom:
                    "var(--sys-frame-border-medium) solid var(--sys-energy-border-default)",
                  background: "var(--sys-energy-surface-secondary)",
                  position: "sticky",
                  top: 0,
              ...
              >
                ...
                {columns.map((col) => (
                  ...
                  >
                    <Text variant="caption" color="inherit" style={{ flex: 1 }}>
                      {col.header}
                    </Text>
                    {col.sortable && (
                      <span
            ...
            <div
              ...
              role="rowgroup"
              // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex -- scrollable container needs tabIndex for keyboard scrolling
              tabIndex={0}
              style={{
                height: `${height}px`,
                overflowY: "auto",
