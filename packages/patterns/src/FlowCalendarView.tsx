...
export const FlowCalendarView = forwardRef<HTMLDivElement, CalendarViewProps>(
  function FlowCalendarView(
    ...
    return (
      <GrowthObserver event="flow.calendar-view.impression">
        <div ref={ref} {...rest} className={className} data-size={resolvedSize} style={style}>
          <Stack gap={2}>
            ...
            <Inline
              align="center"
              justify="between"
              style={{ padding: "var(--ref-frame-space-1) 0" }}
            >
                  ...
                  >
                    ...
                    {dayEvents.length > 0 && (
                      <Stack gap={0} style={{ marginTop: "var(--ref-frame-space-micro)" }}>
                        {dayEvents.slice(0, 2).map((ev) => (
                          <div
                            ...
                            style={{
                              ...
                              background: ev.color
                                ? `color-mix(in srgb, ${ev.color} 15%, transparent)`
                                : "var(--sys-energy-surface-accent-subtle)",
                              color: "var(--sys-energy-text-primary)",
                              borderLeft: `2px solid ${ev.color ?? "var(--sys-energy-status-info)"}`,
                              overflow: "hidden",
                        ...
                        {dayEvents.length > 2 && (
                          <Text variant="overline" color="tertiary" style={{ textAlign: "center" }}>
