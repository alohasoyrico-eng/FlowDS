...
type IconButtonVariant = "primary" | "secondary" | "tertiary" | "outlined" | "ghost";
type IconButtonIntent = "default" | "danger" | "warning";
...
export const FlowIconButton = memo(
  forwardRef<HTMLButtonElement, IconButtonProps>(
    (
      ...
      const button = (
        <GrowthObserver
          event="flow.icon-button.impression"
