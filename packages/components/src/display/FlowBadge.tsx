...
import { GrowthObserver, Text } from "@flow/primitives";
...
export const FlowBadge = memo(
  forwardRef<HTMLSpanElement, BadgeProps>(function FlowBadge(
    {
      children,
      content,
      variant = "count",
    ...
    const badge = (
      <GrowthObserver event="flow.badge.impression" properties={{ variant, status }} inline>
        <span
          ref={ref}
          {...rest}
