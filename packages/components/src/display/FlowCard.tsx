...
import "../../css/display/ImageWithFallback.css";
...
type CardStatus = "neutral" | "info" | "success" | "warning" | "error";
...
export interface CardProps {
  ...
  /** Card size variant */
  size?: CardSize;
  /** Semantic status accent border indicator */
  status?: CardStatus;
...
export const FlowCard = forwardRef<HTMLDivElement, CardProps>(function FlowCard(
  {
    children,
    elevation = 1,
    variant = "default",
  ...
  const showBorder = !isStat && elevation === 0 && !status;
