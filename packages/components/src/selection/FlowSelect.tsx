...
export const FlowSelect = forwardRef<HTMLDivElement, SelectProps>(function FlowSelect(
  {
    label,
    options,
  ...
  return (
    <GrowthObserver event="flow.select.impression" properties={{ size: resolvedSize }} inline>
      ...
      >
        <button
          ...
          aria-activedescendant={
            open && highlightIndex >= 0
              ? `${listboxId}-option-${enabledOptions[highlightIndex]?.value}`
              : undefined
          }
        ...
        >
          {/* Floating label */}
          <Text as="span" variant="label-s" className="flow-input-surface-label flow-select-label">
            {label}
            {required && " *"}
          </Text>
          ...
          <span className="flow-select-value">
            {selectedOption ? (
              ...
              <Text
                ...
                variant="caption"
                color="secondary"
                className="flow-select-placeholder"
              >
            ...
            {options.map((option, _idx) => {
              ...
              return (
                ...
                >
                  ...
                  <Text as="span" variant="label-m" className="flow-select-option-label">
                    {option.label}
                  </Text>
