...
import { FlowIcon, GrowthObserver, Text, useFlowLocale } from "@flow/primitives";
...
export const FlowPagination = forwardRef<HTMLElement, PaginationProps>(function FlowPagination(
  {
    page,
    totalPages,
    onChange,
            ...
            if (typeof p === "string") {
              return (
                <Text
                  ...
                  as="span"
                  variant="label-m"
                  className="flow-pagination-ellipsis"
                  aria-hidden="true"
                >
                  ...
                </Text>
