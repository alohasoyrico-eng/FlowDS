...
import { ActionSurface, FlowIcon, GrowthObserver, Text } from "@flow/primitives";
...
export const FlowSidebar = forwardRef<HTMLElement, SidebarProps>(function FlowSidebar(
  {
    groups: groupsProp,
    items: itemsProp,
            ...
            <div key={gi}>
              {group.label && !collapsed && (
                <Text
                  ...
                  variant="label-s"
                  color="secondary"
                  className="flow-sidebar-group-label"
                >
                  {group.label}
                </Text>
              )}
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!collapsed && (
                      <Text as="span" variant="label-m" className="flow-sidebar-item-label">
                        {item.label}
                      </Text>
                    )}
                  </El>
