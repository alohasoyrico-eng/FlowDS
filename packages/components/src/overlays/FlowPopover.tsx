...
import "../../css/overlays/Popover.css";
import {
  type CSSProperties,
  forwardRef,
  type ReactNode,
...
import { ActionSurface, GrowthObserver, Surface, useFlowFocusTrap } from "@flow/primitives";
...
export const FlowPopover = forwardRef<HTMLDivElement, PopoverProps>(function FlowPopover(
  {
    trigger,
    children,
    placement = "bottom",
      ...
      <div ref={ref} {...rest}>
        ...
        {isOpen && (
          <Surface
            ...
            role="dialog"
            aria-label={typeof trigger === "string" ? trigger : "Popover"}
            tabIndex={-1}
            elevation={2}
            radius="surface"
            padding="container"
