...
import "../../css/overlays/ContextMenu.css";
      ...
      <GrowthObserver event="flow.context-menu.impression" properties={{}} inline>
        <div ref={ref} {...rest}>
          ...
          {pos && (
            ...
            >
              {label && (
                <Text as="div" variant="label-s" className="flow-context-menu-label">
                  {label}
                </Text>
              )}
                ...
                return (
                  <React.Fragment key={itemKey}>
                    ...
                    >
                      ...
                      <Text as="span" variant="label-m" className="flow-context-menu-item-label">
                        {item.label}
                      </Text>
                      {item.shortcut && (
                        <Text
                          ...
                          variant="caption"
                          color="secondary"
                          className="flow-context-menu-item-shortcut"
                        >
                          {item.shortcut}
                        </Text>
                      )}
