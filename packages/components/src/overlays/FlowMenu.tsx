...
export const FlowMenu = forwardRef<HTMLDivElement, MenuProps>(function FlowMenu(
  {
    items,
    onSelect,
    trigger,
    ...
    <GrowthObserver event="flow.menu.impression" properties={{ placement }} inline>
      <div ref={ref} {...rest}>
        ...
        {isOpen && (
          ...
          >
            {label && (
              <Text as="div" variant="label-s" className="flow-menu-label">
                {label}
              </Text>
            )}
            {items.map((item, index) => {
              ...
              return (
                <React.Fragment key={item.id ?? item.key ?? `menu-${index}`}>
                  <ActionSurface
                  ...
                  >
                    ...
                    <Text as="span" variant="label-m" className="flow-menu-item-label">
                      {item.label}
                    </Text>
                    {item.trailing && (
                      <Text
                        ...
                        variant="caption"
                        color="secondary"
                        className="flow-menu-item-trailing"
                      >
                        {item.trailing}
                      </Text>
                    )}
